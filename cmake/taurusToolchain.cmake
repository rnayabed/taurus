...
if(NOT DEFINED TAURUS_TARGET_TRIPLET OR TAURUS_TARGET_TRIPLET STREQUAL "")
    message(FATAL_ERROR "TAURUS_TARGET_TRIPLET required")
endif()



# Configure toolchain path if provided
if (DEFINED TAURUS_TOOLCHAIN_PATH AND NOT TAURUS_TOOLCHAIN_PATH STREQUAL "")
    set(TAURUS_TOOLCHAIN_FULL_PATH ${TAURUS_TOOLCHAIN_PATH}/bin/${TAURUS_TARGET_TRIPLET})
else()
    set(TAURUS_TOOLCHAIN_FULL_PATH ${TAURUS_TARGET_TRIPLET})
endif()
