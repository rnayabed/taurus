/***************************************************
 ...
 Project Code		: HD083D
 Created		: 08-Aog-2021
 Filename		: adafruit_demo.c
 Purpose		: adafruit io Demo
 Description		: adafruit iot Demo with uart interface
...
/**
 @file wifi_iot_post_demo.c
 @brief Contains routines for ESP8266 wifi module http post demonstration
 */
...
void main() {
	...
	modem_connect_wifi("VEGA","CDAC1234");
	...
	while(1){
	 ...
	 double T, P;
		...
		//count=count+10;	
		modem_connect_remote(3,"io.adafruit.com",80);
		sprintf(send_str,"{\"value\": %.2f}",T);		
		modem_POST_remote(3,"/api/v2/premjithav/feeds/temperature/data","io.adafruit.com",send_str);
		usleep(1000000);

		modem_connect_remote(3,"io.adafruit.com",80);
		sprintf(send_str,"{\"value\": %.1f}",P);		
		modem_POST_remote(3,"/api/v2/premjithav/feeds/pressure/data","io.adafruit.com",send_str);
		//usleep(1000000);
		
		/*modem_GET_remote(3,"/api/v2/premjithav/feeds/button/data/last?x-aio-key=aio_rBLO84WP8RPIFpRHrV2CF7MZ9tRl","io.adafruit.com","");
		modem_GET_response();
		udelay(100000);
		modem_GET_remote(3,"/api/v2/premjithav/feeds/button/data/last?x-aio-key=aio_rBLO84WP8RPIFpRHrV2CF7MZ9tRl","io.adafruit.com","");
		modem_GET_response();
